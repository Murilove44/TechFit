...
document.querySelector(".burguer-menu").addEventListener("click", function () {
    this.classList.toggle("active");
});

const btn = document.querySelector(".burguer-menu");
const menu = document.querySelector(".cabecario-menu");
